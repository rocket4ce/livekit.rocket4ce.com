...
turn:
    enabled: true
    domain: livekit-turn.rocket4ce.com
    tls_port: 5349
    udp_port: 3478
    external_tls: true
ingress:
    rtmp_base_url: rtmp://livekit.rocket4ce.com:1935/x
    whip_base_url: https://livekit-whip.rocket4ce.com/w
keys:
    APIWmQgEonLB2FP: 3Ce7au9gn0gSzpL4vmq1C80M1y4m4Se1snSJhDJWcLM
...
apps:
  tls:
    certificates:
      automate:
        - livekit.rocket4ce.com
        - livekit-turn.rocket4ce.com
        - livekit-whip.rocket4ce.com
  layer4:
    servers:
      main:
        listen: [":443"]
...
redis:
    ...
    cluster_addresses: []
    max_redirects: null
api_key: APIWmQgEonLB2FP
api_secret: 3Ce7au9gn0gSzpL4vmq1C80M1y4m4Se1snSJhDJWcLM
ws_url: wss://livekit.rocket4ce.com
